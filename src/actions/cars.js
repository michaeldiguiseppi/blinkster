...
/* This could just be a const, but the function allows for if we need to make any changes to the URL, or append anything, etc */
function baseUrl () {
...
// There should be a less verbose way of doing this, but it works.
